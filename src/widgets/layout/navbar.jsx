...
export function Navbar({ brandName, routes, action }) {
  ...
  const [isAuthenticated, setIsAuthenticated] = React.useState(false); // حالة لمتابعة مصادقة المستخدم
  ...
  React.useEffect(() => {
    ...
    setIsAuthenticated(!!token); // إذا كان هناك توكن، فالمستخدم مصادق
  }, []);
  ...
  // إذا كان المسار الحالي هو صفحة تسجيل الدخول، لا تعرض النافبار
